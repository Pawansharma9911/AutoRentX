...
const ManageCars = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
        <Title title='Manage Cars' subTitle='View all listed cars,update their details,remove them from the booking platform.'/>
                    ...
                    {cars.map((car,index)=>(
                        ...
                        <td className='p-3 flex items-center gap-3'>
                         ...
                         <td className='flex items-center p-3'>
                                ...
                                <img onClick={()=>toggleAvailabilty(car._id)} src={car.isAvaliable ? assets.eye_close_icon : assets.eye_icon} alt=""  className='cursor-pointer'/>
